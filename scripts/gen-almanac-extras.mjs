...
/** English → Hebrew display names for almanac cities and sites */
const NAME_HE = {
  // Cities
  Jerusalem: 'ירושלים',
  Haifa: 'חיפה',
  ...
  'Pyramids of Giza': 'הפירמידות בגיזה',
  'Mount Fuji': 'הר פוגי',
  'Statue of Liberty': 'פסל החירות',
  'Brandenburg Gate': 'שער ברלין',
  'Obelisk of Buenos Aires': 'עמוד האובליסק',
  'Sydney Opera House': 'בית האופרה של סידני',
  'Taj Mahal': 'טאג׳ מהאל',
  'Buckingham Palace': 'ארמון בקינגהאם',
  'Christ the Redeemer': 'פסל ישו הגואל',
  'Hagia Sophia': 'מסגד האייה סופיה',
  Colosseum: 'הקולוסיאום',
  'Royal Palace of Madrid': 'המשפחה המלכותית במדריד',
  'Red Square': 'כיכר האדום',
  'Great Wall of China': 'חומת סין הגדולה',
  'Grand Palace': 'ארמון הגראנד',
  Acropolis: 'האקרופוליס',
  'Teotihuacan pyramids': 'הפירמידות של טאוטיהואקאן',
  'Niagara Falls': 'מגדל ניאגרה',
  'Anne Frank House': 'בית אנה פרנק',
  'Table Mountain': 'הר טבל',
  'Dead Sea': 'ים המלח',
  Masada: 'מצדה',
  ...
  'Notre Dame': 'קתדרלת נוטr-דאam',
  'Palace of Versailles': 'ארמון וrsailles',
  'Champs-Élysées': 'שדרות האליזה',
  'Mont Saint-Michel': 'מון סן-מישל',
  'Great Sphinx': 'סfinx הגדול',
  ...
  'Tokyo Tower': 'מגדל טokyo',
  'Imperial Palace': 'ארמון הקיסr',
  'Tsukiji Fish Market': 'שוק הדגים צukiji',
  'Grand Canyon': 'הגרand canyon',
  'Golden Gate Bridge': 'גשר golden gate',
  'Times Square': 'כיכr times square',
  'White House': 'הבית הלבן',
  Yellowstone: 'פארק يلlowstone',
  'Neuschwanstein Castle': 'טירת n',
  'Black Forest': 'היער השחור',
  'Cologne Cathedral': 'קתדרalat koln',
  'Berlin Wall Memorial': 'אנדרטת חomת berlin',
  'Iguazu Falls': 'מפלי אiguazu',
  'Perito Moreno Glacier': 'קרחon perito moreno',
  'La Boca': 'לה בoca',
  Patagonia: 'פatagonia',
  'Sydney Harbour Bridge': 'גשר sydney harbour',
  Uluru: 'אuluru',
  'Great Barrier Reef': 'שit ha-michsah ha-gadol',
  ...
  'Ancient Olympia': 'olympia ha-atikah',
...
function he(nameEn) {
  return NAME_HE[nameEn] ?? nameEn
}

/** Extra cities beyond the in-game city and capital */
const EXTRA_CITIES = {
